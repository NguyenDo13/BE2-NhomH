               ...
               <div class="row mx-auto">
                    ...
                    <div class="product col-md-3 text-center">
                         <div class="image-item">
                              ...
                              <img class="" style="width: 100%; height:100%" src="{{ asset('assets/clients/images/product-2.png') }}" alt="">
                         </div>
                         <div class="item-content">
                    ...
                    <div class="product col-md-3 text-center">
                         <div class="image-item">
                              ...
                              <img class="" style="width: 100%; height:100%" src="{{ asset('assets/clients/images/product-3.png') }}" alt="">
                         </div>
                         <div class="item-content">
                    ...
                    <div class="product col-md-3 text-center">
                         <div class="image-item">
                              ...
                              <img class="" style="width: 100%; height:100%" src="{{ asset('assets/clients/images/product-4.png') }}" alt="">
                         </div>
                         <div class="item-content">
