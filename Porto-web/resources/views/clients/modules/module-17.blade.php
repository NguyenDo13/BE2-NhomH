<div class="module-17">
    <div class="container">
        <div class="col-md-7 " style="float: right;">
            ...
            <div class="row">
                <h4 class="price"> <span>$209.00 - $269.00</span></h4>
            ...
            <div class="buttons_added qty">
                ...
                <input aria-label="quantity" class="input-qty" max="100" min="0" name="" type="number" value="1">
                <button class="plus is-form" type="button" value="+">+</button>
            </div>
            <div class="buttons_added">
                <button class="add" type="submit" style="font-weight: bold;font-size: 13px">
