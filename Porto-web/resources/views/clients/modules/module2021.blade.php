                ...
                <div class="u-columns col2-set">
                        ...
                        <form action="" class="formSignin">
                            ...
                            <div class="Remember-password d-flex flex-column flex-sm-row justify-content-between mb-4">
                                <div class="checkbox-login my-2 my-sm-0">
                                    <input type="checkbox" name="rememberme" id="rememberme" value="forever" class="control-input">
                                    <label class="label-control no-radius" for="rememberme">Remember me</label>
                                </div>
                                <a href="" class="text-v-dark font-weight-semibold">Forgot Password?</a>
                            </div>
                            <p class="form-row mb-3 mb-lg-0 pb-1 pb-lg-0">
                                <input type="hidden" id="login-btn" name="login-btn" value="ca1cd3182f" /><input type="hidden" name="_wp_http_referer" value="/wordpress/porto/shop1/my-account/" />
                                <button type="submit" class="Login-Button button login-btn btn-v-dark py-3 text-md w-100" name="login" value="Login">
                                    LOGIN</button>
                            </p>
                        </form>
                    </div>
                    <div class="u-column2 col-2">
                        <form action="" class="formSignin">
                            ...
                            <div class="Remember-password d-flex flex-column flex-sm-row justify-content-between mb-4">
                                <label for="" style="color: #777777;">A link to set a new password will be sent to your email address.</label>
                            </div>
                            <p class="form-row mb-3 mb-lg-0 pb-1 pb-lg-0">
                                <input type="hidden" id="login-btn" name="register-btn" value="ca1cd3182f" /><input type="hidden" name="_wp_http_referer" value="/wordpress/porto/shop1/my-account/" />
                                <button type="submit" class="Login-Button button login-btn btn-v-dark py-3 text-md w-100" name="register" value="Register">
                                    REGISTER</button>
                            </p>
                        </form>
                    </div>
