<div class="module-19 products">
    <div class="pad-module">
        <div class="container mt-5 py-3 title-module">
            ...
            <div class="row mx-auto">
                <div class="product col-md-3 text-center">
                    <div class="image-item">
                        ...
                        <img class="" style="width: 100%; height:100%"
                            src="<?php echo e(asset('assets/clients/images/product-1.png')); ?>" alt="">
                    </div>
                ...
                <div class="product col-md-3 text-center">
                    <div class="image-item">
                        ...
                        <img class="" style="width: 100%; height:100%"
                            src="<?php echo e(asset('assets/clients/images/product-2.png')); ?>" alt="">
                    </div>
                    <div class="item-content">
                ...
                <div class="product col-md-3 text-center">
                    <div class="image-item">
                        ...
                        <img class="" style="width: 100%; height:100%"
                            src="<?php echo e(asset('assets/clients/images/product-3.png')); ?>" alt="">
                    </div>
                    <div class="item-content">
                        ...
                        <div class="star-item">
                            <i class="fa fa-star" style="color: #6f6e6b;"></i><i class="fa fa-star"
                                style="color: #6f6e6b;"></i><i class="fa fa-star"></i><i
                                class="fa fa-star"></i><i class="fa fa-star"></i>
                        </div>
                        <div class="price-item">
                            <span>
                ...
                <div class="product col-md-3 text-center">
                    <div class="image-item">
                        ...
                        <img class="" style="width: 100%; height:100%"
                            src="<?php echo e(asset('assets/clients/images/product-4.png')); ?>" alt="">
                    </div>
                    <div class="item-content">
...
<?php /**PATH D:\Back-end2\BE2-NhomH\Porto-web\resources\views/clients/modules/module-19.blade.php ENDPATH**/ ?>