<div class="module-17">
    <div class="container">
        <div class="col-md-12 " style="float: right;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php echo $__env->make('clients.modules.module-18', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\Back-end2\BE2-NhomH\Porto-web\resources\views/clients/modules/module-17.blade.php ENDPATH**/ ?>